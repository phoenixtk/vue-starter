  ...
  export default {
    ...
    computed:   {
      cssClasses() {
        ...
        if (this.radius) {
          classes.push(this.$style.radius);
        }

        if (this.size) {
          classes.push(this.$style.size);
        }
...
<style lang="scss" module>
  ...
  .button {
    ...
    color:                       $button-default-color-inverse;
    ...
    font-weight:                 $button-font-weight-550;
    ...
    &.radius {
      // border-radius: $button-border-radius;
      border-radius: $button-border-radius-10;
    }
